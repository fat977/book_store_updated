...
@section('title', __('dashboard/sidebar.downloadable.edit'))
@section('css')
<!-- ckeditor -->
...
<div class="content-wrapper">
    <div class="row p-4">
        ...
        <div class="col-12">
            <form action="{{ route('admin.downloadable_books.update', $downloadableBook->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-row">
                    <div class="col-6">
                        <label for="name_en">{{__('dashboard/sidebar.commons.name_en')}}</label>
                        @php $name = implode($downloadableBook->getTranslations('name',['en'])); @endphp
                    ...
                    <div class="col-6">
                        ...
                        @php $name = implode($downloadableBook->getTranslations('name',['ar'])); @endphp
                ...
                <div class="form-row">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" name="size" id="size" class="form-control" value="{{ $downloadableBook->size }}">
                        @error('size')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-4">
                        ...
                        value="{{ $downloadableBook->no_pages }}">                    
                        @error('no_pages')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="col-4">
                        ...
                        <select name="status" id="Status" class="form-control">
                            <option {{ $downloadableBook->status == 1 ? 'selected' : '' }} value="1">{{__('dashboard/sidebar.commons.active')}}</option>
                            <option {{ $downloadableBook->status == 0 ? 'selected' : '' }} value="0">{{__('dashboard/sidebar.commons.not_active')}}</option>
                        </select>
                        @error('status')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-4">
                        ...
                        <select name="author_id" id="author_id" class="form-control">
                            @foreach ($authors as $author)
                                <option {{ $downloadableBook->author_id == $author->id ? 'selected' : '' }}
                                    value="{{ $author->id }}">
                                    {{ $author->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-4">
                        ...
                        <select name="category_id" id="category_id" class="form-control">
                            @foreach ($categories as $category)
                                <option {{ $downloadableBook->category_id == $category->id ? 'selected' : '' }}
                ...
                <div class="form-row">
                    <div class="col-6">
                        ...
                        @php $desc = implode($downloadableBook->getTranslations('desc',['en'])); @endphp
                    ...
                    <div class="col-6">
                        ...
                        @php $desc = implode($downloadableBook->getTranslations('desc',['ar'])); @endphp
                ...
                <div class="form-row">
                    <div class="col-6">
                        ...
                        @php $publisher = implode($downloadableBook->getTranslations('publisher',['en'])); @endphp
                    ...
                    <div class="col-6">
                        ...
                        @php $publisher = implode($downloadableBook->getTranslations('publisher',['ar'])); @endphp
                ...
                <div class="form-row">
                    <div class="col-6">
                        ...
                        value="{{ old('released_date',$downloadableBook->released_date) }}">                    
                    </div>
                    @error('released_date')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    <div class="form-row my-3">
                        ...
                        <div class="col-4">
                            <img src="{{ asset('storage/downloadedBook/images/' . $downloadableBook->image) }}" alt="{{ $downloadableBook->name }}"
